...
static const PduR_RoutingTableType bcm_pdur_routing[] = {
    ...
    { BCM_COM_RX_XCP_REQ_CVC,  PDUR_DEST_XCP,  BCM_COM_RX_XCP_REQ_CVC },   /* 0x550 XCP_Req_CVC → XCP */
    { BCM_COM_RX_XCP_RESP_CVC,  PDUR_DEST_COM,  BCM_COM_RX_XCP_RESP_CVC },   /* 0x551 XCP_Resp_CVC */
    { BCM_COM_RX_XCP_REQ_FZC,  PDUR_DEST_XCP,  BCM_COM_RX_XCP_REQ_FZC },   /* 0x552 XCP_Req_FZC → XCP */
    { BCM_COM_RX_XCP_RESP_FZC,  PDUR_DEST_COM,  BCM_COM_RX_XCP_RESP_FZC },   /* 0x553 XCP_Resp_FZC */
    { BCM_COM_RX_XCP_REQ_RZC,  PDUR_DEST_XCP,  BCM_COM_RX_XCP_REQ_RZC },   /* 0x554 XCP_Req_RZC → XCP */
    { BCM_COM_RX_XCP_RESP_RZC,  PDUR_DEST_COM,  BCM_COM_RX_XCP_RESP_RZC },   /* 0x555 XCP_Resp_RZC */
    { BCM_COM_RX_XCP_REQ_SC,  PDUR_DEST_XCP,  BCM_COM_RX_XCP_REQ_SC },   /* 0x556 XCP_Req_SC → XCP */
    { BCM_COM_RX_XCP_RESP_SC,  PDUR_DEST_COM,  BCM_COM_RX_XCP_RESP_SC },   /* 0x557 XCP_Resp_SC */
