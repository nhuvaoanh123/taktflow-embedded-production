// Taktflow Systems - ICU DoCAN transport layer implementation
...
// ICU diagnostic addressing: tester sends on 0x614, ICU responds on 0x61C
// Transport source = 0xF0 (tester), target = 0x14 (ICU logical address)
DoCanSystem::AddressingFilterType::AddressEntryType DoCanSystem::_addresses[]
    = {{0x614u, 0x61Cu, 0x00F0u, 0x0014u, 0, 0}};
