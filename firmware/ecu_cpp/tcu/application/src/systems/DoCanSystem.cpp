// Taktflow Systems - TCU DoCAN transport layer implementation
...
// TCU diagnostic addressing: tester sends on 0x615, TCU responds on 0x61D
// Transport source = 0xF0 (tester), target = 0x15 (TCU logical address)
DoCanSystem::AddressingFilterType::AddressEntryType DoCanSystem::_addresses[]
    = {{0x615u, 0x61Du, 0x00F0u, 0x0015u, 0, 0}};
